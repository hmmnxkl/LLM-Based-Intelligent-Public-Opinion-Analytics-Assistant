...
class DouyinGeneralHotSpider1(DouyinHotSearchBaseSpider):
    name = 'douyin_fun_hot'
    custom_settings = {
    ...
    def hotlist_url(self):
        return 'https://so-landing.douyin.com/aweme/v1/hot/search/list/?aid=581610&detail_list=1&board_type=2&board_sub_type=2&need_board_tab=false&need_covid_tab=false&version_code=32.3.0'
